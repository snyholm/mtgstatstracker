...
- mtgstatstracker-addon: addon module, custom server and client side code 
- mtgstatstracker-ui: main application module
- mtgstatstracker-backend: backend module, contains any server side java code and dependencies
